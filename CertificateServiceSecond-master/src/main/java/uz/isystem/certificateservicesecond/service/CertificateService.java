...
public class CertificateService {
    ...
    private void generateImage(BufferedImage qr, Certificate certificate, String path) {
        String originalPath = assets + "/img/certificat.jpg";
        ...
        try {
            ...
            rectangle.x = 470;
            rectangle.y = 990;
            rectangle.width = 1721;
            rectangle.height = 277;
            ...
            graphics.drawImage(qr, 2910, 1900, qr.getWidth(), qr.getHeight(), null);
    ...
    public BufferedImage generateQR(String url) {
        try {
            ...
            BitMatrix bitMatrix = writer.encode(url, BarcodeFormat.QR_CODE, 340, 340);
